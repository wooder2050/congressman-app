...
export function useLawmakeQuery<
...
export function useLawmakeSuspenseQuery<
  TQueryFn extends (...args: any[]) => Promise<any>,
  TParams extends Parameters<TQueryFn>,
  TData = Awaited<ReturnType<TQueryFn>>,
>(
...
export type UseLawmakeInfiniteQueryOptions<
  TQueryFn extends (...args: any[]) => Promise<any>,
  TPageParam,
> = Omit<
  UseInfiniteQueryOptions<
...
export function useLawmakeInfiniteQuery<
  TQueryFn extends (...args: any[]) => Promise<any>,
  TPageParam,
>(
  apiFn: TQueryFn,
  getParams: (arg: { pageParam: TPageParam }) => Parameters<TQueryFn>,
  options: UseLawmakeInfiniteQueryOptions<TQueryFn, TPageParam>
): UseInfiniteQueryResult<
  InfiniteData<Awaited<ReturnType<TQueryFn>>, TPageParam>,
  Error
> {
